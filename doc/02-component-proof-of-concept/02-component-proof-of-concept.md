...
I've chosen to implement my idea for a bitmap image, I feel that it is complex enough to be interesting as a component, but isn't beyond my skill to implement. By making the image non-resizable, I can significantly cut down on the skill required to create this.
