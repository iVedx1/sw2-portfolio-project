...
- Created a JUnit test suite for kernel and Standard behavior in `BitMapImage1Test`
- Created a JUnit test suite for secondary methods in `BitMapImageSecondaryTest`
- Added `BitMapImageGradientDemo` as a pixel-processing use case
- Added `BitMapImageFlagRendererDemo` as a row/column rendering use case
